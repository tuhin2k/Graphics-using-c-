...
//    drawAxis();
    ...
    while(1)
    {
        ...
        polygon2.push_back(PT(rectPosx,200));
        polygon2.push_back(PT(rectPosx,0));
        polygon2.push_back(PT(rectPosx+300, 0));
        polygon2.push_back(PT(rectPosx+300, 200));
...
//        for(int i=35;i<=38;i++) drawLine(PT(-window_W,-90+i),PT(window_W,-90+i),GREEN);

        drawLine(PT(-window_W,-90),PT(window_W,-90),GREEN);
        drawLine(PT(-window_W,-90-1),PT(window_W,-90-1),GREEN);


        //pieslice(center2.x,center2.y,0,90,40);
//        pieslice(center2.x,center2.y,180,270,40);
        ...
        int yy1 = -200 + (window_H/2);


        if(tmpp == true)
        {
            scanLine(polygon2,RED);
            cout << "uprer tmpp" << tmpp << endl;
        }
