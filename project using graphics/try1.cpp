...
void click_handler(int x, int y)
{
    ...
    int y1 = -20 + window_H/2;


    if((x >= x1 && x <= x1 + 20) && (y >= y1 && y <= window_H /2 ))
    {
//        printf("%d %d\n",x,y);
        double a = double(x);
        double b = double(y);
    ...
    while(1)
{
    ...
    polygon2.push_back(PT(rectPosx,20));
    polygon2.push_back(PT(rectPosx,0));
    polygon2.push_back(PT(rectPosx+20, 0));
    polygon2.push_back(PT(rectPosx+20, 20));
